    ...
    var TunnelWidget = function TunnelWidget(props) {
      ...
      var langSt = React.useState(function () {
        try {
          ...
          return snap && snap.active ? snap.active : 'en'
        } catch (e) { return 'en' }
      })
      var lang = langSt[0]
      var setLang = langSt[1]
      React.useEffect(function () {
        if (localeService === null || typeof localeService.subscribe !== 'function') return undefined
        return localeService.subscribe(function () {
          try {
            var snap = localeService.getLocale()
            setLang(snap && snap.active ? snap.active : 'en')
          } catch (e) {}
        })
      }, [])
      ...
      if (open) {
        ...
        panel = React.createElement('div', { style: panelStyle, ref: panelRef, className: 'pt-panel' },
          ...
          state !== null && state.error ? React.createElement('div', { style: { color: P.err, marginTop: 4 } }, t(lang, 'err') + state.error) : null,
