...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var TunnelWidget = function TunnelWidget() {
      ...
      // pool view: keep the table fresh while the panel is open
      React.useEffect(function () {
        if (!open || state === null) return undefined
        var id = setInterval(function () {
          stateJson().then(function (s) { setState(s) }).catch(function () {})
        }, 10000)
        return function () { clearInterval(id) }
      }, [open, state === null ? null : (state.pool ? state.pool.gen : 'n')])
      ...
      if (open) {
        ...
        panel = React.createElement('div', { style: panelStyle, ref: panelRef },
          React.createElement('div', { style: { fontWeight: 700, marginBottom: 6 } }, 'Cloudflare Tunnel — Phone access'),
          ...
          state !== null && state.prereqs ? Object.keys(state.prereqs).map(function (k) {
            ...
            return React.createElement('div', { key: k, style: { color: '#d4a72c', marginTop: 4, fontSize: 12 } },
              'Prereq missing: ' + (p.hint || k))
          }) : null,
